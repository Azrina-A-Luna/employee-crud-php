...
(function (za, O, l) {
  var N = function (h) {
    ...
    function G(a, b, c) {
      ...
      h.each(b, function (e) {
        ...
        if (d !== l && (c || b[d] === l))
          "o" === d.charAt(0)
            ? (b[d] || (b[d] = {}), h.extend(!0, b[d], b[e]), G(a[d], b[d], c))
            : (b[d] = b[e]);
      });
    }
    function N(a) {
      ...
      !a.sEmptyTable &&
        ...
        D(a, a, "sZeroRecords", "sEmptyTable");
      !a.sLoadingRecords &&
        c &&
        "Loading..." === b.sLoadingRecords &&
        D(a, a, "sZeroRecords", "sLoadingRecords");
    ...
    function Da(a) {
      ...
      for (f = b.length; e < f; e++)
        if (((m = b[e]), (k = []), !m.sType && m._sManualType))
          ...
          for (g = o.length; f < g; f++)
            if ("number" === typeof o[f] && 0 <= o[f]) {
              ...
              for (i = m.length; j < i; j++)
                ("_all" == o[f] || h(m[j].nTh).hasClass(o[f])) && d(j, n);
            }
        }
      if (c) {
        e = 0;
    ...
    function I(a, b, c, d) {
      var e = a.aoData.length,
        f = h.extend(!0, {}, p.models.oRow, { src: c ? "dom" : "data" });
      f._aData = b;
      a.aoData.push(f);
      for (var b = a.aoColumns, f = 0, g = b.length; f < g; f++)
        c && Ea(a, e, f, A(a, e, f)), (b[f].sType = null);
      ...
      var c = [],
        ...
        o = function (a, b, c) {
          "string" === typeof a &&
            ((b = a.indexOf("@")),
            -1 !== b &&
              ((a = a.substring(b + 1)), (j["@" + a] = c.getAttribute(a))));
        },
        k = function (a) {
          g = m[i];
      ...
      if (null === e.nTr) {
        ...
        for (o = a.aoColumns.length; m < o; m++) {
          ...
          if (!c || h.mRender || h.mData !== m)
            i.innerHTML = A(a, b, m, "display");
          h.sClass && (i.className += " " + h.sClass);
          h.bVisible && !c
            ? j.appendChild(i)
            : !h.bVisible && c && i.parentNode.removeChild(i);
          h.fnCreatedCell &&
            h.fnCreatedCell.call(a.oInstance, i, A(a, b, m), f, b, m);
        }
        ...
        for (e = g.length; d < e; d++) {
          ...
          for (b = g[d].length; f < b; f++)
            if (((n = i = 1), j[d][f] === l)) {
              ...
              for (
                j[d][f] = 1;
                g[d + i] !== l && g[d][f].cell == g[d + i][f].cell;
        ...
        if (0 !== i.length) {
          ...
          for (j = j ? 0 : g; j < f; j++) {
            ...
            if (0 !== e) {
              var k = d[c % e];
              o._sRowStripe != k &&
                (h(m).removeClass(o._sRowStripe).addClass(k),
                (o._sRowStripe = k));
            }
    ...
    function lb(a) {
      ...
      for (
        var f = a.sDom.split(""), g, j, i, n, m, o, k = 0;
        k < f.length;
        k++
      ) {
        g = null;
    ...
    function na(a, b, c) {
      ...
      i = {
        ...
        error: function (b, c) {
          var d = a.oApi._fnLog;
          "parsererror" == c
            ? d(a, 0, "Invalid JSON response", 1)
            : 4 === b.readyState && d(a, 0, "Ajax error", 7);
          B(a, !1);
        },
      };
      a.oAjaxData = b;
    ...
    function ca(a, b, c) {
      ...
      if ("ssp" != z(a)) {
        ub(
          ...
          b.sSearch,
          c,
          b.bEscapeRegex !== l ? !b.bEscapeRegex : b.bRegex,
          b.bSmart,
          b.bCaseInsensitive
        );
        f(b);
        for (b = 0; b < e.length; b++)
          vb(
            ...
            e[b].sSearch,
            b,
            e[b].bEscapeRegex !== l ? !e[b].bEscapeRegex : e[b].bRegex,
            e[b].bSmart,
    ...
    function wb(a) {
      for (
        var b = p.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length;
        f < g;
        f++
      ) {
        for (var j = [], i = 0, h = c.length; i < h; i++)
          (e = c[i]),
            (d = a.aoData[e]),
    ...
    function vb(a, b, c, d, e, f) {
      if ("" !== b)
        for (
          var g = a.aiDisplay, d = Na(b, d, e, f), e = g.length - 1;
          0 <= e;
          e--
        )
        ...
        if (((h = a.aoData[d]), !h._aFilterData)) {
          ...
          for (g = b.length; e < g; e++)
            (c = b[e]),
              ...
              i.indexOf &&
                -1 !== i.indexOf("&") &&
                ((qa.innerHTML = i), (i = Wb ? qa.textContent : qa.innerText)),
    ...
    function ra(a) {
      ...
      if (a.bInitialised) {
        ...
        for (c = e.length; b < c; b++)
          (f = e[b]), f.sWidth && (f.nTh.style.width = s(f.sWidth));
        L(a);
        e = z(a);
        "ssp" != e &&
          ("ajax" == e
          ...
          fn: function (a) {
            if (d) {
              ...
              for (o = f.p.length; m < o; m++)
                La(a, "pageButton")(a, f.p[m], m, h, b, i);
            } else c.fnUpdate(a, e);
          },
          sName: "pagination",
        }));
    ...
    function Ra(a, b, c) {
      ...
      0 === f || -1 === e
        ...
        : P(a, 0, "Unknown paging action: " + b, 5);
    ...
    function W(a) {
      ...
      J &&
        ((w = J.clone().prependTo(q)), (t = J.find("tr")), (w = w.find("tr")));
      ...
      b.bCollapse &&
        "" !== e &&
        (k.height = o[0].offsetHeight + r[0].offsetHeight + "px");
      g = q.outerWidth();
      if ("" === c) {
        if (
          ((M.width = "100%"),
          v &&
            (q.find("tbody").height() > i.offsetHeight ||
              "scroll" == o.css("overflow-y")))
        )
          M.width = s(q.outerWidth() - f);
      } else
        "" !== d
          ? (M.width = s(d))
          : g == o.width() && o.height() < q.height()
          ? ((M.width = s(g - f)), q.outerWidth() > g - f && (M.width = s(g)))
          : (M.width = s(g));
      g = q.outerWidth();
      F(E, x);
      F(function (a) {
      ...
      if (q.outerWidth() < g) {
        t =
          i.scrollHeight > i.offsetHeight || "scroll" == o.css("overflow-y")
            ? g + f
            : g;
        if (
          v &&
      ...
      e &&
        b.bCollapse &&
        ((k.height = s(e)),
        (b = c && da.offsetWidth > i.offsetWidth ? f : 0),
        da.offsetHeight < i.offsetHeight &&
          (k.height = s(da.offsetHeight + b)));
      b = q.outerWidth();
      m[0].style.width = s(b);
      n.width = s(b);
    ...
    function Ca(a) {
      ...
      if (!o && !f && !e && j == Z(a) && j == i.length)
        ...
        j = h(b)
          ...
          .removeAttr("id")
          .append(h(a.nTHead).clone(!1))
          .append(h(a.nTFoot).clone(!1))
        ...
        for (k = 0; k < d.length; k++)
          (l = c[d[k]]),
            (i[k].style.width =
              null !== l.sWidthOrig && "" !== l.sWidthOrig
                ? s(l.sWidthOrig)
                : "");
        if (a.aoData.length)
          for (k = 0; k < d.length; k++)
            (o = d[k]),
              (l = c[o]),
              h(Db(a, o)).clone(!1).append(l.sContentPadding).appendTo(p);
        j.appendTo(m);
        f && g
          ? j.width(g)
          : f
          ? (j.css("width", "auto"),
            j.width() < m.offsetWidth && j.width(m.offsetWidth))
          : e
          ? j.width(m.offsetWidth)
          : n && j.width(n);
        Eb(a, j[0]);
        if (f) {
          for (k = g = 0; k < d.length; k++)
            (l = c[d[k]]),
              ...
              (g +=
                null === l.sWidthOrig
                  ? e
                  : parseInt(l.sWidth, 10) + e - h(i[k]).width());
          j.width(s(g));
          b.style.width = s(g);
        }
        for (k = 0; k < d.length; k++)
          if (((l = c[d[k]]), (e = h(i[k]).width()))) l.sWidth = s(e);
    ...
    function Gb() {
      if (!p.__scrollbarWidth) {
        var a = h("<p/>").css({ width: "100%", height: 200, padding: 0 })[0],
          b = h("<div/>")
            .css({
              position: "absolute",
              top: 0,
    ...
    function Hb(a, b) {
      ...
      for (
        var f,
          g = p.ext.type.order[c.sType + "-pre"],
          j = 0,
          i = a.aoData.length;
        j < i;
        j++
        ...
        if (
          ...
          (f = d ? e[j] : A(a, j, b, "sort")), (c._aSortData[b] = g ? g(f) : f);
    }
    function ta(a) {
    ...
    function Ua(a, b) {
      ...
      b <= c
        ? (c = S(0, b))
        : a <= d
        ? ((c = S(0, c - 2)), c.push("ellipsis"), c.push(b - 1))
        : (a >= b - 1 - d
            ? (c = S(b - (c - 2), b))
            : ((c = S(a - 1, a + 2)), c.push("ellipsis"), c.push(b - 1)),
    ...
    p = function (a) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          n = k.oClasses;
          g.bJQueryUI
            ? (h.extend(n, p.ext.oJUIClasses, g.oClasses),
              g.sDom === m.sDom &&
                "lfrtip" === m.sDom &&
                (k.sDom = '<"H"lfr>t<"F"ip>'),
              k.renderer)
              ? h.isPlainObject(k.renderer) &&
                !k.renderer.header &&
                (k.renderer.header = "jqueryui")
              : (k.renderer = "jqueryui")
            : h.extend(n, p.ext.classes, g.oClasses);
          h(this).addClass(n.sTable);
          if ("" !== k.oScroll.sX || "" !== k.oScroll.sY)
            k.oScroll.iBarWidth = Gb();
          !0 === k.oScroll.sX && (k.oScroll.sX = "100%");
          k.iInitDisplayStart === l &&
            ((k.iInitDisplayStart = g.iDisplayStart),
            (k._iDisplayStart = g.iDisplayStart));
          null !== g.iDeferLoading &&
            ((k.bDeferLoading = !0),
            (j = h.isArray(g.iDeferLoading)),
            (k._iRecordsDisplay = j ? g.iDeferLoading[0] : g.iDeferLoading),
            (k._iRecordsTotal = j ? g.iDeferLoading[1] : g.iDeferLoading));
          "" !== g.oLanguage.sUrl
            ? ((k.oLanguage.sUrl = g.oLanguage.sUrl),
              ...
              (e = !0))
            : h.extend(!0, k.oLanguage, g.oLanguage);
          null === g.asStripeClasses &&
            (k.asStripeClasses = [n.sStripeOdd, n.sStripeEven]);
          ...
          -1 !==
            ...
            (h("tbody tr", this).removeClass(j.join(" ")),
            (k.asDestroyStripes = j.slice()));
          var o = [],
            q,
          ...
          g.bStateSave &&
            ((t.bStateSave = !0),
            Jb(k, g),
            x(k, "aoDrawCallback", ta, "state_save"));
          if (g.aaSorting === l) {
            o = k.aaSorting;
            j = 0;
            for (i = o.length; j < i; j++)
              o[j][1] = k.aoColumns[j].asSorting[0];
          }
          sa(k);
          t.bSort &&
          ...
          0 === i.length || 0 === i.children().length
            ? h(this).addClass(n.sNoFooter)
            : 0 < i.length && ((k.nTFoot = i[0]), aa(k.aoFooter, k.nTFoot));
          if (g.aaData) for (j = 0; j < g.aaData.length; j++) I(k, g.aaData[j]);
          else
            (k.bDeferLoading || "dom" == z(k)) &&
              ha(k, h(k.nTBody).children("tr"));
          ...
          if ("table" === b) (e = c(n[f], f)), e !== l && d.push(e);
            ...
            for (i = o.length; h < i; h++)
              (e = o[h]),
                (e =
                  "cell" === b
                    ? c(n[f], e.row, e.column, f, h)
                    : c(n[f], e, f, h, m)),
                e !== l && d.push(e);
          }
        return d.length
          ? ((a = new q(n, a ? d.concat.apply([], d) : d)),
            (b = a.selector),
            (b.rows = k.rows),
            (b.cols = k.cols),
            (b.opts = k.opts),
    ...
    var Za = function (a, b) {
        ...
        for (g = a.length; f < g; f++) {
          ...
          for (i = e.length; j < i; j++)
            (d = b("string" === typeof e[j] ? h.trim(e[j]) : e[j])) &&
              d.length &&
              c.push.apply(c, d);
        }
        return c;
      ...
      ab = function (a) {
        for (var b = 0, c = a.length; b < c; b++)
          if (0 < a[b].length)
            return (
              (a[0] = a[b]), (a.length = 1), (a.context = [a.context[b]]), a
            );
        a.length = 0;
        return a;
      },
      ...
      var b = $a(b),
        c = this.iterator("table", function (c) {
          ...
          return Za(a, function (a) {
            ...
            if (!a) return j;
            for (var b = [], i = 0, n = j.length; i < n; i++)
              b.push(c.aoData[j[i]].nTr);
            return a.nodeName && h.inArray(a, b) !== -1
              ? [a._DT_RowIndex]
              : h(b)
                  .filter(a)
                  .map(function () {
    ...
    var bb = function (a) {
        ...
        b.length &&
          ...
          ((a = b[0].aoData[a[0]]),
          a._details &&
            (a._details.remove(), (a._detailsShow = l), (a._details = l)));
      },
      Tb = function (a, b) {
        var c = a.context;
          ...
          if (d._details) {
            ...
            0 < C(g, "_details").length &&
              ...
              f.on("column-visibility.dt.DT_details", function (a, b) {
                if (e === b)
                  for (var c, d = Z(b), f = 0, h = g.length; f < h; f++)
                    (c = g[f]),
                      c._details &&
    ...
    r("cells()", function (a, b, c) {
      h.isPlainObject(a) &&
        (typeof a.row !== l ? ((c = b), (b = null)) : ((c = a), (a = null)));
    ...
    r("cell().data()", function (a) {
      var b = this.context,
        c = this[0];
      if (a === l)
        return b.length && c.length ? A(b[0], c[0].row, c[0].column) : l;
    ...
    h.extend(p.ext.type.detect, [
      ...
      function (a) {
        return H(a) || ("string" === typeof a && -1 !== a.indexOf("<"))
          ? "html"
          : null;
      },
    ]);
  ...
  "function" === typeof define && define.amd
    ? define("datatables", ["jquery"], N)
    : "object" === typeof exports
    ? N(require("jquery"))
    : jQuery && !jQuery.fn.dataTable && N(jQuery);
})(window, document);

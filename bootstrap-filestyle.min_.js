  ...
  Filestyle.prototype = {
    ...
    constructor: function () {
      ...
      btn =
        ...
        _self.options.btnClass +
        " " +
        (_self.options.size == "nr" ? "" : "btn-" + _self.options.size) +
        '" ' +
        (_self.options.disabled || _self.$element.attr("disabled")
          ? ' disabled="true"'
          : "") +
        ">" +
        _self.htmlIcon() +
      ...
      _self.$elementFilestyle
        .find(_self.options.buttonBefore ? "label" : ":input")
        .css({
      ...
      _self.$elementFilestyle
        ...
        .on("drop", function (e) {
          if (
            ...
            !_self.options.disabled &&
            _self.options.dragdrop
          ) {
